...
class TimeTable{    // eslint-disable-line no-unused-vars
    ...
    */
    addFirstColumn(base){
        ...
        const INDEX = this.c.getIndex(this.v.shiftTime);
        // Column of Header
        base.find("#theader").prepend("<th>SÂN</th>");
        // Column of Data
    ...
    */
    setWorkTimeColumn(){
        ...
        tbody.each((i,elem)=>{
			...
			$(elem).append(`<td class="TimeTable__worktime js-workTime"><button class='btnDatSan btn'>Đặt</button></td>`);
        });
    }
    /**
    ...
    */
    initialDraw(){
        ...
        for(;;){
			...
			let shape = this.drawLine(index,sTime,eTime,2,over);
