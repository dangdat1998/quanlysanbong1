		...
		function taoDsKhachHang() {
			$.ajax({
				...
				success: function(json) {
					...
					html += "<thead><tr><th>#</th><th>Tên KH</th><th>Số điện thoại</th><th>Chức vụ</th><th>Sửa</th></tr></thead>";
					for (var i = 0; i < data.length; i++) {
						...
						html += "<tr>";
						html += "<td>" + (i + 1) + "</td><td>" + data[i].ten + "</td><td>" + data[i].sdt + "</td><td>"+chucvu[i]+"</td><td><center><button class='btn-edit' ma_kh='" + data[i].id +"' order='" + (i + 1) + "'>Sửa</button></center></td>";
						html += "</tr>";
					}
					html += "</table>";
